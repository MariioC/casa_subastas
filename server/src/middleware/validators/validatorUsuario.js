...
const usuarioSchema = Joi.object().keys({
    ...
    genero: Joi.string().max(1).valid('Hombre', 'Mujer', 'Otro').required().messages({
        'string.base': 'El campo género no tiene un formato válido',
        'any.only': 'El valor del campo género no es válido',
        'any.empty': 'El campo género es obligatorio',
